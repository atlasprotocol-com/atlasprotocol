      ...
      <div className="flex flex-col gap-4 text-sm">
        <div className="flex flex-col gap-4 md:flex-row">
          <div className={`${cardStyles} flex-1`}>
            <p className="text-xs dark:text-neutral-content">From</p>
            <p className="mb-3">{`${fromChain?.networkName}`}</p>
            <p className="text-xs dark:text-neutral-content">To</p>
            <p className="mb-3">{`${toChain?.networkName}`}</p>
