...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={twMerge(
      "font-semibold bg-neutral-6 dark:bg-neutral-11",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={twMerge(
      "h-12 px-4 text-left align-middle font-semibold bg-neutral-3 dark:bg-neutral-9",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={twMerge(
      "p-4 align-middle [&:has([role=checkbox])]:pr-0 border-b border-neutral-4 dark:border-neutral-9",
      className,
    )}
    {...props}
  />
