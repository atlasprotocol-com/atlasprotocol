...
contract atBTC is ERC20, ERC20Burnable, ERC20Pausable, Ownable2Step {
    ...
    // Prevent renouncing ownership to ensure the contract always has an owner
    ...
    function mintBridge(
        address to,
        uint256 amount,
        string memory originChainId,
        string memory originChainAddress,
        string memory originTxnHash
